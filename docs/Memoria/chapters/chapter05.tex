...
162.120~MM\$ en 2013 a 277.519~MM\$ en 2025. No obstante, esta
...
actividad sectorial. Los años 2013 y 2025 registran únicamente
las 7~CAC supervisadas por la CMF, sin cobertura DAES, por lo
que su comparación directa con años de mayor cobertura debe
considerar esta diferencia de composición.
...
2015 & 14 & 1.561.464,4 & 518.169,3 &   747.250,6 & 1.354.989,9 \\
2016 & 14 & 1.676.817,7 & 538.454,0 &   850.229,6 & 1.424.771,8 \\
2017 & 14 & 1.843.430,6 & 527.343,1 &   858.659,3 & 1.578.414,4 \\
2018 & 17 & 2.033.489,7 & 558.139,3 &   938.557,9 & 1.699.568,9 \\
2019 & 13 & 2.229.477,7 & 591.968,6 & 1.062.063,1 & 1.840.175,1 \\
2020 & 16 & 2.586.910,7 & 645.841,7 & 1.357.193,1 & 1.873.316,1 \\
2021 & 15 & 2.886.670,0 & 687.708,6 & 1.692.111,5 & 1.955.032,9 \\
2022 & 22 & 3.233.454,7 & 801.186,4 & 1.885.462,4 & 2.376.704,3 \\
2023 & 25 & 3.736.816,3 & 852.394,0 & 2.314.442,1 & 2.823.975,3 \\
2024 & 18 & 4.164.706,7 & 906.844,0 & 2.596.172,9 & 3.123.457,0 \\
2025 &  7 & 4.481.909,0 & 915.240,0 & 2.761.339,0 & 3.369.182,0 \\
\bottomrule
\end{tabularx}
\par\vspace{0.5em}
...
cooperativo \cite{comision_para_el_mercado_financiero_informe_2025}. Este dato corresponde a un corte transversal de diciembre de 2025 y se aplica de forma
constante a los trece años de la serie (2013--2025), bajo el supuesto de que la participación
patrimonial relativa de las CAC dentro del sistema bancario y cooperativo se ha mantenido
estable en el tiempo. Este supuesto no ha sido verificado con series históricas de patrimonio
y constituye una simplificación necesaria dada la disponibilidad de un único punto de
referencia externo. Bajo
...
del período. El aporte estimado muestra una concordancia cercana con este rango en 2013, 2014, 2021 y
2025 --definiendo como umbral de concordancia una diferencia inferior a 0,01 puntos
porcentuales respecto del aporte esperado, y como discrepancia relevante una diferencia
superior a 0,02 puntos porcentuales--, pero se ubica sistemáticamente por debajo del valor
esperado entre 2017 y 2020 (brecha de hasta 0,03 puntos porcentuales). Se recuerda que la cifra de aporte total CMF~+~DAES
utilizada en esta validación corresponde a una aproximación de orden
de magnitud, conforme a lo señalado en la Sección~\ref{sec:limitaciones},
y no a una suma metodológicamente exacta entre segmentos. En conjunto,
el orden de magnitud de las estimaciones es consistente con la
referencia externa utilizada, lo que respalda su plausibilidad general
pese a las limitaciones metodológicas documentadas.
% ==================================================
...
\begin{figure}[H]
    ...
    \caption{Distribución regional de las CAC de ahorro y
    crédito identificadas en el registro consolidado del
    proyecto. La Región Metropolitana concentra 20 de las
    36~cooperativas registradas.}
...
alberga 20 de las 36~cooperativas de ahorro y crédito
identificadas en el registro consolidado del proyecto,
equivalente al 56\,\% del total. Valparaíso
y la Araucanía son las siguientes regiones con mayor
presencia, con 4 y 3~CAC respectivamente. El resto de
...
\item \textbf{Ausencia de empleo para el segmento DAES.}
  ...
  \item \textbf{Reproducibilidad computacional.} El código
  y los datos utilizados en las estimaciones no se
  encuentran consolidados en un único repositorio con
  control de versiones al momento de esta entrega. El panel
  de datos y el script del tablero interactivo están
  disponibles en el repositorio del proyecto; la
  trazabilidad completa del pipeline de cálculo (agregación
  de P1, P2 y B1g, y las validaciones cruzadas de la
  sección~\ref{sec:agregado-total}) queda pendiente de
  publicación como trabajo posterior a esta memoria.
