...
author: "Sebastián Cea Echenique · Joaquín Fernández"
date: today
lang: es
...
**B1g** = lo que la organización *agrega* con su propio trabajo — eso, y solo
eso, entra al PIB. Luego se reparte entre remuneraciones (**D1**) y excedente
de explotación (**B2g**).
:::
...
**Sebastián Cea Echenique · Joaquín Fernández**

Proyecto Huella Social — Laboratorio de Ingeniería Financiera (LIF)

Facultad de Ingeniería y Ciencias Aplicadas, Universidad de los Andes

::: {.callout-note title="Caso de aplicación"}
Ignacio Ureta y Antonio Ruiz Tagle — memoria de título, Ingeniería Civil
Industrial, FICA UANDES (2026).
:::

::: {.aside-text}
Tablero interactivo: [github.com/Iureta1/Dashboard\_HuellaSocial](https://github.com/Iureta1/Dashboard_HuellaSocial) ·
Metodología y registro de decisiones: `ingUANDES/huellasocial`
:::
...
2. **Fuentes de los datos presentados** — de qué cuadro de la memoria sale cada
   número de esta presentación
3. **Nota sobre los gráficos** — criterios de diseño y cómo se generan
