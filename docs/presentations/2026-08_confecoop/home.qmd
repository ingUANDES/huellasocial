...
Dentro del sistema financiero chileno, en cambio, la cifra sí es comparable:

| Referencia | % del PIB (2025) |
|:--|--:|
| Servicios financieros — sector completo (BCCh) | 3,1 |
| **Cooperativas de ahorro y crédito** | **0,082** |

::: {.aside-text}
Las CAC son un **2,6 %** del valor agregado financiero del país. La CMF, por una
vía independiente, les atribuye un **2,41 %** del patrimonio del sistema bancario
y cooperativo: dos mediciones distintas que coinciden.
:::
