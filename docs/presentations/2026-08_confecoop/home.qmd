...
date: today
lang: es
institute: "Proyecto Huella Social — FICA, Universidad de los Andes. Prof. guía: Sebastián Cea Echenique"
...
**Producción (P1)** = todo lo que la cooperativa ingresa por su operación
(intereses, reajustes, inversiones).

**Consumo intermedio (P2)** = lo que le compra a terceros para operar
(servicios, insumos, arriendos).

**Valor agregado (B1g)** = lo que la cooperativa *agrega* con su propio trabajo.
Eso, y solo eso, es lo que entra al PIB.
:::
...
::: {.aside-text}
El valor agregado se reparte entre quienes trabajan en la cooperativa (D1) y el
excedente que queda para socios y reservas (B2g). Cifras 2025, MM\$ corrientes.
:::
...
Ningún dato reservado, ninguna encuesta: el estudio se construye sobre lo que las
cooperativas **ya publican**. La calidad del resultado depende de cuánto publiquen.
:::
...
::: {.aside-text}
El segmento CMF explica más del 90 % del valor agregado en todos los años. El
salto de 2022–2023 refleja en parte más cooperativas DAES incorporadas al panel,
no solo crecimiento real.
:::
...
::: {.aside-text}
Entre 38 % y 52 % del valor agregado se paga como remuneraciones — una
...
::: {.aside-text}
Las colocaciones netas representan entre 68 % y 90 % de los activos en todo el
período: el sector es, estructuralmente, un sector de crédito a sus socios.
:::
...
::: {.aside-text}
20 de las 36 CAC del catastro del proyecto están en la Región Metropolitana (56 %);
Valparaíso (4) y La Araucanía (3) siguen. El segmento DAES pesa poco en stocks
agregados, pero es el que sostiene la cobertura territorial fuera de la RM.
:::
...
::: {.aside-text}
Aporte esperado = participación de "Servicios financieros" en el PIB (BCCh) × 2,41 %
(peso patrimonial de las cooperativas en el sistema bancario y cooperativo, CMF
dic-2025). Dos caminos de cálculo totalmente distintos llegan al mismo orden de magnitud.
:::
...
::: {.aside-text}
En ningún año el panel cubre las 38 CAC vigentes del registro DAES. El mejor año
(2023) llega a 22. Cada memoria no publicada es valor agregado real que
simplemente no entra en la cifra.
:::
...
La cobertura de 2024 cae a 11 CAC porque las memorias no estaban publicadas. Un
acuerdo gremial de publicación en plazo **sube la cifra del sector sin cambiar una
sola línea de metodología**.
:::
...
reemplaza la extracción manual y automatiza la actualización anual.
:::
